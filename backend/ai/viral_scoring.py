...
EMOTION_WORDS = {
    ...
    "extraordinary", "phenomenal", "magnificent", "explosive", "stunning",
    "game-changer", "legendary", "iconic", "epic", "wild", "crazy",
    "awesome", "outstanding", "exceptional", "remarkable", "terrific",
    # Negative / dramatic
    ...
    "mistake", "warning", "risk", "threat", "collapse", "destroy",
    "horrifying", "nightmare", "catastrophe", "devastating", "fatal",
    # Curiosity / mystery
    "truth", "lie", "myth", "fact", "real", "fake",
    "never", "always", "everyone", "nobody", "unknown", "mystery",
    "bizarre", "strange", "weird", "odd", "secret", "hidden",
    # Social proof & scale
    "million", "billion", "viral", "trending", "popular", "famous",
    "record", "first", "last", "only", "unique", "exclusive",
    "world", "global", "history", "ever", "greatest",
}

STORYTELLING_MARKERS = {
    "i was", "it started", "one day", "back then", "years ago",
    "suddenly", "everything changed", "i realized", "i discovered",
    "i never thought", "nobody told me", "what happened next",
    "the moment i", "that's when", "here's what",
    "the truth is", "turns out", "what i found", "the real reason",
    "nobody knows", "most people", "they don't want",
    "let me tell you", "you won't believe", "this is the story",
    "it all began", "from that day", "i have to share",
}

URGENCY_WORDS = {
    "now", "today", "immediately", "urgent", "critical", "deadline",
    "limited", "last chance", "before it's too late",
    "running out", "disappearing", "expiring", "final",
    "hurry", "quickly", "right now", "this week", "don't wait",
}

CONTRAST_WORDS = {
    "but", "however", "although", "despite", "instead", "actually",
    "surprisingly", "unexpectedly", "ironically", "contrary",
    "wrong", "turns out", "in reality", "in fact",
    "thought it was", "nobody expected", "against all odds",
    "what people miss", "the opposite", "plot twist",
}
